...
public interface Database
{
     ...
     */
    boolean insertSeveralRecipes(ArrayList<Recipe> recipes);

    /**
     * Inserts on {@link Step } into the Database
     *
     * @param belonging the name of the recipe to which the article belongs
     * @param step      The step to be inserted
     * @return true, if the articl e was inserted successfully else false
     */
    boolean insertStep(String belonging, Step step);

    /**
     * Inserts a list of Steps into the database
     *
     * @param recipeName# the name of the Recipe / the belonging of the steps
     * @param steps       the list of steps
     * @return
     */
    boolean insertSeveralSteps(String recipeName, ArrayList<Step> steps);
     ...
     * @return
     */
    boolean insertSeveralArticles(String belonging, ArrayList<Article> articles);

    /**
     * Inserts one Article
     *
     * @param belonging the belonging of the article
     * @param article   the article itself
     * @return
     */
    boolean insertArticle(String belonging, Article article);
     ...
     * @param belonging the belonging of the Article
     */
    void deleteArticle(String name, String belonging);

    /**
     * Removes one specific step from one recipe
     *
     * @param name      the name of the Step
     * @param belonging the name of the recipe to which the step belongs
     */
    void deleteStep(String name, String belonging);
     ...
     */
    ArrayList<Recipe> retrieveAllRecipes();
     ...
     *
     * @param belonging and String which indicates to which list or recipe
     *                  an article in the database belongs
     * @return ArrayList<Article> with all matching Articles
     */
    ArrayList<Article> retrieveAllArticlesFrom(String belonging);


    //....Update ..........

    void updateRecipe(String oldName, Recipe newRecipe);
     ...
     * article
     *
     * @param oldName   The name of the updated Article(before changes was made
     *                  / can be the same as the name of the new article ).
     * @param belonging Teh belonging of the Article (Available, Buying or the name of the Recipe)
     * @param article   the updated version of the article
     */
    void updateArticle(String oldName, String belonging, Article article);
     ...
     * step
     *
     * @param oldName   The name of the updated step (before changes was made
     *                  / can be the same as the name of the new step ).
     * @param belonging The belonging of the step (Available, Buying or the name of the Recipe)
     * @param step      the updated version of the step
     */
    void updateStep(String oldName, String belonging, Step step);
